...
<>
        <div className="flex gap-5">
          ...
          <div className=" flex flex-col h-20 w-40 bg-blue-100 rounded-xl p-5 ">
          ...
          <div className=" flex flex-col h-20 w-40 bg-green-100 rounded-xl p-5 ">
       ...
       <div className=" flex flex-col h-20 w-40 bg-yellow-100 rounded-xl p-5 ">
          ...
          <div className=" flex flex-col h-20 w-40 bg-red-100 rounded-xl p-5 ">
